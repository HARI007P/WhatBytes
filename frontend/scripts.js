        ...
        <div class="data-card">
            <div class="card-header">
                <div>
                    ...
                    <div class="card-info">Age: ${patient.age} | Disease: ${patient.disease}</div>
                </div>
...
const displayDoctors = (doctors) => {
    ...
    doctorList.innerHTML = doctors.map(doctor => `
        <div class="data-card">
            <div class="card-header">
                <div>
                    <div class="card-title">Dr. ${doctor.name}</div>
                    <div class="card-info">Specialization: ${doctor.specialization}</div>
                </div>
                <div class="card-actions">
...
const displayMappings = (mappings) => {
    ...
    if (mappings.length === 0) {
        mappingList.innerHTML = `
            <div class="empty-state">
                ...
                <p>Start by creating patient-doctor mappings</p>
            </div>
        `;
        return;
    }
    ...
    mappingList.innerHTML = mappings.map(mapping => `
        <div class="data-card">
            <div class="card-header">
                <div>
                    <div class="card-title">${mapping.patient_name} → Dr. ${mapping.doctor_name}</div>
                    <div class="card-info">
                        Patient: ${mapping.patient_age} years, ${mapping.patient_disease} | 
                        Doctor: ${mapping.doctor_specialization}
                    </div>
                </div>
                <div class="card-actions">
                    <button class="btn btn-danger" onclick="deleteMapping(${mapping.id})">Remove</button>
                </div>
            </div>
        </div>
    `).join('');
